...
export const DemoControlBar = () => {
  ...
  return (
    <div className="glass-panel rounded-xl p-3.5 mb-6 border-indigo-300 dark:border-indigo-800 bg-gradient-to-r from-indigo-100/70 via-white to-purple-100/70 dark:from-indigo-950/40 dark:via-slate-900 dark:to-purple-950/40 flex flex-wrap items-center justify-between gap-3 shadow-md">
      <div className="flex items-center gap-3">
        <div className="flex items-center gap-2 px-3 py-1 rounded-lg bg-indigo-600 text-white font-black text-xs shadow-sm">
          <span className="w-2 h-2 rounded-full bg-white animate-ping" />
          SIH DEMO MODE
        </div>
        <p className="text-xs text-slate-800 dark:text-slate-200 font-bold hidden md:block">
          Simulate underground coal mine roof stress conditions for live SIH demonstration:
        </p>
      </div>
