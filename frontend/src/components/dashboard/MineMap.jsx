  ...
  return L.divIcon({
    ...
    html: `
      <div class="relative flex items-center justify-center cursor-pointer">
        ...
        <div class="relative z-10 w-9 h-9 rounded-full flex items-center justify-center text-white font-bold text-xs shadow-lg border-2 border-white dark:border-slate-900 transition-transform duration-300 hover:scale-110" style="background-color: ${color}">
          ${nodeId}
        </div>
...
export const MineMap = ({ nodesData = {}, onSelectNode }) => {
  ...
  return (
    <div className="w-full h-[420px] rounded-xl overflow-hidden relative shadow-inner border border-slate-200/80 dark:border-slate-800">
              ...
              >
                <Popup className="mine-node-popup">
                  <div className="p-1 max-w-xs font-sans text-slate-800">
                    ...
                    <div className="grid grid-cols-2 gap-1.5 text-[11px] bg-slate-50 p-2 rounded mb-2 border border-slate-100">
      ...
      {/* Map Legend Overlay */}
      <div className="absolute bottom-3 right-3 z-[400] glass-panel px-3 py-2 rounded-lg text-xs flex items-center gap-3 backdrop-blur-md">
        <span className="font-bold text-slate-600 dark:text-slate-300">Mine Seam Nodes:</span>
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[11px] text-slate-600 dark:text-slate-300">Med</span>
        </div>
        <div className="flex items-center gap-1.5">
        ...
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-[11px] text-slate-600 dark:text-slate-300 font-bold">Critical</span>
        </div>
      </div>
    </div>
  );
